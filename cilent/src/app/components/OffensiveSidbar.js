...
const OffcanvasSidebar = ({ isOpen, toggleOffcanvas, setIsOpen }) => {
    ...
    const onSubmit = async (values, { setSubmitting, setErrors }) => {
        try {
            const url = isLoginForm ? 'https://delivery-point-master-backend.onrender.com/customer/login' : 'https://delivery-point-master-backend.onrender.com/customer/signup';
