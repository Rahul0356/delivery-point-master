                    ...
                    <div className="md:w-1/3 p-4 mt-8 md:mt-0">
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="mt-2">Marwadi college hostel-c, Rajkot 360003.</p>
                            </div>
                            <div>
                                <h2 className="text-xl font-bold">Follow Me</h2>
                                <ul className="mt-2 space-y-1">
                                    <Link className='hover:text-orange-500 hover:underline' to="https://github.com/Rahul0356" target='_blank'>Github</Link> <br/>
                                    {/* <Link className='hover:text-orange-500 hover:underline' to="https://x.com/Arman_Ali_01" target='_blank'>TWITTER</Link><br/> */}
                                    <Link className='hover:text-orange-500 hover:underline' to="https://www.linkedin.com/in/rahul-kumar-6bb129245?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target='_blank'>LINKEDIN</Link><br/>
